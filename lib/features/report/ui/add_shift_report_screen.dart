        ...
        builder: (context, state) {
          ...
          return Scaffold(
                ...
                child: AppBar(
                  ...
                  actions: [
                    if (currentUser.role != Role.staff)
                      IconButton(
                        icon: const Icon(Icons.assessment, color: ColorsManger.primary),
                        onPressed: () {
            ...
            body: GestureDetector(
              ...
              child: Stack(
                children: [
                  const _AddShiftReportBackground(),
                  Form(
                    key: _formKey,
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // اختيار نوع الوردية
                          _PanelCard(child: _buildShiftTypeSelector(cubit)),
                         ...
                         /* const SizedBox(height: 20),
                          ...
                          // قسم المصاريف
                          _PanelCard(
                            child: ShiftReportWidgets.buildExpensesSection(
                              expenses: _expenses,
...
class _AddShiftReportBackground extends StatelessWidget {
  const _AddShiftReportBackground();
