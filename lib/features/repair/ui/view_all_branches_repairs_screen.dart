      ...
      child: Builder(
        builder: (context) {
          ...
          return Scaffold(
            ...
            body: Stack(
              children: [
                const _AllBranchesRepairsBackground(),
                Padding(
        ...
        children: [
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.calendar_month, color: ColorsManger.primary, size: 18),
...
class _AllBranchesRepairsBackground extends StatelessWidget {
  const _AllBranchesRepairsBackground();  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
