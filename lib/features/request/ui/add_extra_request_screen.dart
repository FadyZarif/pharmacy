...
class AddExtraRequestScreen extends StatefulWidget {
  final RequestModel? requestModel;
  final bool? isReadOnly ;
  const AddExtraRequestScreen({super.key, this.requestModel, this.isReadOnly});

  @override
  State<AddExtraRequestScreen> createState() => _AddExtraRequestScreenState();
}

class _AddExtraRequestScreenState extends State<AddExtraRequestScreen> {
  ...
  void initState() {
    ...
    if (widget.requestModel != null) {
      final extraHoursDetails = ExtraHoursDetails.fromJson(widget.requestModel!.details);
      date = extraHoursDetails.date;
      extraHoursController.text = extraHoursDetails.hours.toString();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Extra Hours Request'),
                ...
                if (formKey.currentState!.validate()) {
                  ...
                  RequestModel request = RequestModel(
                    ...
                    details: ExtraHoursDetails(
                      date: date!,
                      hours: int.parse(extraHoursController.text),
                    ).toJson(),
