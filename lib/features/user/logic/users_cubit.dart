...
class UsersCubit extends Cubit<UsersState> {
    ...
    try {
      ...
      switch (extension) {
        ...
        case 'webp':
          ...
          break;
        default:
          // Prevent uploading unsupported formats like HEIC/HEIF that break on web.
          throw Exception(
            'Unsupported image format "$extension". Please upload JPG, PNG, or WEBP.',
          );
      }
  ...
  Future<void> updateUser({
    ...
    try {
      ...
      if (branches != null) {
        updatedData['branches'] = branches.map((b) => b.toJson()).toList();
      }
